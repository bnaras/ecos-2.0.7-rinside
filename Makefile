...
TEST_INCLUDES = -Itest -Itest/generated -I/usr/local/Cellar/r/3.5.2/lib/R/include -I/usr/local/lib/R/3.5/site-library/Rcpp/include -I/usr/local/lib/R/3.5/site-library/RInside/include
...
LDFLAGS += -L/usr/local/opt/openblas/lib -L/usr/local/opt/gettext/lib -L/usr/local/opt/readline/lib -L/usr/local/lib -L/usr/local/opt/openblas/lib -L/usr/local/opt/gettext/lib -L/usr/local/opt/readline/lib -L/usr/local/lib -L/usr/local/Cellar/r/3.5.2/lib/R/lib -lR -lpcre -llzma -lbz2 -lz -licucore -lm -liconv  -L/usr/local/opt/openblas/lib -lopenblas   /usr/local/lib/R/3.5/site-library/RInside/lib/libRInside.a
...
ecostester: test/ecostester.cpp $(TEST_OBJS) libecos.a
	$(CXX) $(CFLAGS) $(TEST_INCLUDES) -o $@ $^ $(LDFLAGS)
